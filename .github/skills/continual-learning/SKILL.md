...
description: Guide for implementing continual learning in AI coding agents — hooks, memory scoping, reflection patterns. Use when setting up persistent learning workflows for agents.
---
...
- Prefer Sequelize models/services over raw SQL in backend changes
```
