---
name: copilot-sdk
description: Build applications powered by GitHub Copilot using the Copilot SDK. Use when creating programmatic integrations with Copilot, with TypeScript/Node.js as the primary path for this repository. Covers session management, custom tools, streaming, hooks, MCP servers, BYOK providers, session persistence, custom agents, and skills. Requires GitHub Copilot CLI installed and a GitHub Copilot subscription (unless using BYOK).
---

# GitHub Copilot SDK

Build applications that programmatically interact with GitHub Copilot. The SDK wraps the Copilot CLI via JSON-RPC, providing session management, custom tools, hooks, MCP server integration, and streaming. In this repository, prefer TypeScript + Node.js implementations.
...
|----------|---------|---------|
| Node.js | `@github/copilot-sdk` | `pnpm add @github/copilot-sdk` |
...
provider: {
    type: "openai",
    baseUrl: "https://your-provider.example.com/openai/v1/",
...
### Bearer Token with BYOK

Use short-lived bearer tokens when your provider supports token-based auth:
...
> **Note:** Bearer tokens expire. For long-running apps, refresh the token before creating new sessions.
